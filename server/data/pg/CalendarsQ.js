...
class PostsQ extends DataBase {
    ...
    Insert({ author, title, created_at, status, type }) {
        this.qInsertStmt.text += ` (author, title, created_at, status, type) VALUES($1, $2, $3, $4, $5)`;
        this.qInsertStmt.values = [author, title , created_at, status, type];
