...
class DataBase {
    ...
    Count(customStatement = null, count = "id") { 
        this.currentStmt = {
            text: `SELECT COUNT(${count}) FROM ${this.table}`,
            values: []
        };
    ...
    Get(fields = "*") {
        this.currentStmt = {...this.qSelectStmt, text: `SELECT ${fields} ` + this.qSelectStmt.text};
        return this;
    }

    Join(join) {
        this.currentStmt.text += " JOIN " + join + " ";
        return this;
    }
