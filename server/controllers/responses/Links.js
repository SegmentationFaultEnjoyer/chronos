...
async function GenerateLinks(url, Q, customStmt = null, filter = undefined, sort = undefined, order = undefined, countField = "id") {
    ...
    let dbResp = await Q.New().Count(customStmt, countField).Execute(); 
